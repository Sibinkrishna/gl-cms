               ...
               <div class="d-flex align-items-center gap-1">
                    ...
                    <div class="dropdown topbar-item">
                         ...
                         <div class="dropdown-menu dropdown-menu-end">
                              <!-- item-->
                              <h6 class="dropdown-header">Welcome {{ Auth::user()->name ?? 'Vendor' }}!</h6>
                              <a class="dropdown-item" href="{{ route('vendor.settings.profile') }}">
                                   <i class="bx bx-user-circle text-muted fs-18 align-middle me-1"></i><span class="align-middle">Profile Settings</span>
                              </a>
                              <a class="dropdown-item" href="{{ route('vendor.settings.store') }}">
                                   <i class="bx bx-store text-muted fs-18 align-middle me-1"></i><span class="align-middle">Store Settings</span>
                              </a>
                              <a class="dropdown-item" href="{{ route('vendor.settings.bank') }}">
                                   <i class="bx bx-money text-muted fs-18 align-middle me-1"></i><span class="align-middle">Bank Details</span>
                              </a>
                              <a class="dropdown-item" href="{{ route('vendor.settings.notifications') }}">
                                   <i class="bx bx-bell text-muted fs-18 align-middle me-1"></i><span class="align-middle">Notifications</span>
                              </a>
