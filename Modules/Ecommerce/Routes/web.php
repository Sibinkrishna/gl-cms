...
Route::prefix('vendor')->name('vendor.')->middleware(['vendor.module', 'auth:web', 'vendor.approved'])->group(function () {
    ...
    Route::get('/settings/profile', [VendorSettingsController::class, 'profile'])->middleware('permission:vendor.settings.view,web')->name('settings.profile');
    Route::put('/settings/profile', [VendorSettingsController::class, 'updateProfile'])->middleware('permission:vendor.settings.update,web')->name('settings.profile.update');
    Route::get('/settings/store', [VendorSettingsController::class, 'storeSettings'])->middleware('permission:vendor.settings.view,web')->name('settings.store');
    Route::put('/settings/store', [VendorSettingsController::class, 'updateStoreSettings'])->middleware('permission:vendor.settings.update,web')->name('settings.store.update');
    Route::get('/settings/bank', [VendorSettingsController::class, 'bankDetails'])->middleware('permission:vendor.settings.view,web')->name('settings.bank');
    Route::put('/settings/bank', [VendorSettingsController::class, 'updateBankDetails'])->middleware('permission:vendor.settings.update,web')->name('settings.bank.update');
    Route::get('/settings/notifications', [VendorSettingsController::class, 'notifications'])->middleware('permission:vendor.settings.view,web')->name('settings.notifications');
    Route::put('/settings/notifications', [VendorSettingsController::class, 'updateNotifications'])->middleware('permission:vendor.settings.update,web')->name('settings.notifications.update');
});
